  ...
  return (
    <footer className="relative w-full overflow-hidden bg-[#013727]">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#04c55c] rounded-full filter blur-3xl transform translate-x-1/2 -translate-y-1/2" />
        ...
        <div className={`transition-all duration-1000 delay-600 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4 pt-8">
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 order-2 sm:order-1">
              ...
              <Link to="/privacy-policy" className="text-white/90 text-sm sm:text-base md:text-lg hover:text-[#04c55c] transition-colors duration-300 underline underline-offset-4 decoration-white/30 hover:decoration-[#04c55c]">
                Privacy Policy
              </Link>
              <div className="hidden sm:block w-px h-4 bg-white/30" />
              <Link to="/terms" className="text-white/90 text-sm sm:text-base md:text-lg hover:text-[#04c55c] transition-colors duration-300 underline underline-offset-4 decoration-white/30 hover:decoration-[#04c55c]">
                Terms & Conditions
              </Link>
            </div>

            <div className="flex items-center gap-4 sm:gap-5 order-1 sm:order-2">
              <a href="https://www.facebook.com/profile.php?id=61575194648525" target="_blank" rel="noopener noreferrer" className="w-12 h-12 sm:w-13 sm:h-13 md:w-14 md:h-14 bg-[#1877f2] rounded-full flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-[#1877f2]/60 transition-all duration-300 group" aria-label="Facebook">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>

              <a href="https://www.instagram.com/bestbybites/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 sm:w-13 sm:h-13 md:w-14 md:h-14 bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] rounded-full flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-pink-500/60 transition-all duration-300 group" aria-label="Instagram">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@bestby.bites?_r=1&_t=ZS-92ms0UfKW1Z" target="_blank" rel="noopener noreferrer" className="w-12 h-12 sm:w-13 sm:h-13 md:w-14 md:h-14 bg-black rounded-full flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-black/60 transition-all duration-300 group relative overflow-hidden" aria-label="TikTok">
                <svg className="w-6 h-6 sm:w-7 sm:h-7 relative z-10 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none">
