            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
              ...
              >
                <div className="text-center lg:text-left">
                  ...
                  <div className="flex justify-center lg:justify-start">
                    <button 
                      className="hero-button bg-[#04c55c] text-white rounded-full font-bold hover:bg-[#03a84d] transition-all duration-300 hover:scale-105 shadow-xl active:scale-95 cursor-pointer"
                    >
                      Become a Partner
                    </button>
                  </div>
